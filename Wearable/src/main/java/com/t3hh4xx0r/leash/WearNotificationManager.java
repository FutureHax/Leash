...
public class WearNotificationManager {
    ...
    public static final int FORGOT_PHONE_NOTIFICATION_ID = 1;
...
//                .notify(WEAR_CONTROL_NOTIFICATION, notification.build());
    ...
    public static void dismissAll(Context ctx) {
        ...
        ((android.app.NotificationManager) ctx.getSystemService(ctx.NOTIFICATION_SERVICE)).cancel(FORGOT_PHONE_NOTIFICATION_ID);
    }
}
